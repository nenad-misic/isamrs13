...
export class LoggedUserApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches hasOne relation racservice.
   *
   * @param {any} id LoggedUser id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getRacservice(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/racservice";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in racservice of this model.
   *
   * @param {any} id LoggedUser id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createRacservice(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/racservice";
    let _routeParams: any = {
  ...
  /**
   * Update racservice of this model.
   *
   * @param {any} id LoggedUser id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public updateRacservice(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/racservice";
    let _routeParams: any = {
  ...
  /**
   * Deletes racservice of this model.
   *
   * @param {any} id LoggedUser id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public destroyRacservice(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/racservice";
    let _routeParams: any = {
  ...
  public findByIdMCarReservations(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/mCarReservations/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  public findByIdMRoomReservations(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/mRoomReservations/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  public findByIdMFlightReservations(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/mFlightReservations/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Queries mCarReservations of LoggedUser.
   *
   * @param {any} id LoggedUser id
   *
   * @param {object} filter 
  ...
  public getMCarReservations(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/mCarReservations";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts mCarReservations of LoggedUser.
   *
   * @param {any} id LoggedUser id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countMCarReservations(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/mCarReservations/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries mRoomReservations of LoggedUser.
   *
   * @param {any} id LoggedUser id
   *
   * @param {object} filter 
  ...
  public getMRoomReservations(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/mRoomReservations";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts mRoomReservations of LoggedUser.
   *
   * @param {any} id LoggedUser id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countMRoomReservations(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/mRoomReservations/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries mFlightReservations of LoggedUser.
   *
   * @param {any} id LoggedUser id
   *
   * @param {object} filter 
  ...
  public getMFlightReservations(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/mFlightReservations";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts mFlightReservations of LoggedUser.
   *
   * @param {any} id LoggedUser id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countMFlightReservations(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/mFlightReservations/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyRacservice(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoggedUsers/:id/racservice";
    let _routeParams: any = {
