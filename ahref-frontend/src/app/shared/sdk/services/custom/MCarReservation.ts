...
/**
 * Api services for the `MCarReservation` model.
 */
@Injectable()
export class MCarReservationApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id mCarReservation id
   *
  ...
  public getLoggedUser(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/mCarReservations/:id/loggedUser";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
