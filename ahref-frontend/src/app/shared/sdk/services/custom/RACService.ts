...
/**
 * Api services for the `RACService` model.
 */
@Injectable()
export class RACServiceApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getDestination(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RACServices/:id/destination";
  ...
  /**
   * Find a related item by id for branchOffices.
   *
   * @param {any} id RACService id
   *
   * @param {any} fk Foreign key for branchOffices
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdBranchOffices(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RACServices/:id/branchOffices/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for branchOffices.
   *
   * @param {any} id RACService id
   *
   * @param {any} fk Foreign key for branchOffices
   ...
   */
  public destroyByIdBranchOffices(id: any, fk: any, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Update a related item by id for branchOffices.
   *
   * @param {any} id RACService id
   *
   * @param {any} fk Foreign key for branchOffices
   ...
   * </em>
   */
  public updateByIdBranchOffices(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Queries branchOffices of RACService.
   *
   * @param {any} id RACService id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getBranchOffices(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RACServices/:id/branchOffices";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in branchOffices of this model.
   *
   * @param {any} id RACService id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createBranchOffices(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RACServices/:id/branchOffices";
    let _routeParams: any = {
  ...
  /**
   * Deletes all branchOffices of this model.
   *
   * @param {any} id RACService id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteBranchOffices(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RACServices/:id/branchOffices";
    let _routeParams: any = {
  ...
  /**
   * Counts branchOffices of RACService.
   *
   * @param {any} id RACService id
   *
   ...
   *  - `count` – `{number}` - 
   */
  public countBranchOffices(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RACServices/:id/branchOffices/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   *  - `retval` – `{object}` - 
   */
  public updateConcurentSafe(new_rac: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RACServices/updateConcurentSafe";
    let _routeParams: any = {};
    let _postBody: any = {
      new_rac: new_rac
    };
   ...
   * </em>
   */
  public createManyBranchOffices(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RACServices/:id/branchOffices";
    let _routeParams: any = {
